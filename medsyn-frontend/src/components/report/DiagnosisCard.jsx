    ...
    >
      ...
      <div className="h-1.5 bg-gray-100">
        <motion.div className={`h-full ${colors.bar}`}
          initial={{ width: 0 }}
          animate={{ width: `${pct}%` }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: index * 0.12 + 0.35 }}
        />
      </div>
      ...
      <div className="px-4 py-3">
        <div className="flex items-start justify-between gap-3 mb-2">
          <div className="flex items-center gap-2.5">
            <motion.span
              ...
              className="w-6 h-6 rounded-lg bg-teal-700 text-white text-xs font-bold flex items-center justify-center flex-shrink-0"
          ...
          <motion.span
            ...
            className={`badge flex-shrink-0 py-0.5 ${colors.pill}`}>
            {pct}%
          </motion.span>
        </div>
        ...
        {diagnosis.regional_prevalence && (
          <motion.div
            ...
            className="mt-2.5 rounded-xl bg-teal-50 border border-teal-100 px-3 py-2 flex items-start gap-2">
